...
int main( int /*argc*/, const char **argv )
{
	...
	isis::glance::data::Image gImage( isisImages, glance::data::types::FLOAT );

	std::cout << "typeID float: " << glance::data::types::FLOAT << std::endl;
	...
	gImage.setDataType( glance::data::types::DOUBLE );
